...
const blogPosts = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>Use relative units like em or rem rather than fixed pixels to create more flexible typographic systems that scale appropriately across devices.</p>

      <h2 id="conclusion">Conclusion</h2>
      <p>Typography is both an art and a science. By mastering these fundamentals, you'll be able to create designs that not only look beautiful but also communicate effectively and provide a better user experience.</p>
      <p>Remember that great typography often goes unnoticed because it does its job so well. When type is properly set, readers focus on the content rather than the design—and that's the ultimate goal of typographic excellence.</p>
    `,
    coverImage: "https://images.unsplash.com/photo-1467951591042-f388365db261?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    date: "2023-11-05",
  ...
  {
    id: 5,
    title: "Color Theory in Modern Digital Design",
    slug: "color-theory-in-modern-digital-design",
    excerpt: "Understand how to use color effectively in digital products to create emotional impact and improve usability.",
    content: `
      <p>Color is one of the most powerful tools in a designer's toolkit. It can influence emotions, guide attention, establish brand identity, and enhance usability. This article explores the fundamentals of color theory and how to apply them in modern digital design.</p>

      <h2 id="color-basics">Understanding Color Basics</h2>
      <p>Before diving into advanced color concepts, it's essential to understand the basic properties of color:</p>
      <p><strong>Hue:</strong> The color itself (red, blue, green, etc.).</p>
      <p><strong>Saturation:</strong> The intensity or purity of the color.</p>
      <p><strong>Value:</strong> The lightness or darkness of a color.</p>
      <p>These three properties form the foundation of color theory and provide a framework for creating effective color schemes.</p>

      <h2 id="color-harmony">Creating Color Harmony</h2>
      <p>Color harmony refers to the arrangement of colors that create a pleasing aesthetic experience. Several traditional color schemes can guide your selections:</p>
      <p><strong>Monochromatic:</strong> Various tints, tones, and shades of a single hue.</p>
      ...
      <p><strong>Triadic:</strong> Three colors equally spaced around the color wheel.</p>

      <h2 id="emotional-impact">The Emotional Impact of Color</h2>
      <p>Colors can evoke specific emotions and associations, though these can vary based on cultural context. For example:</p>
      <p><strong>Blue:</strong> Often associated with trust, calm, and reliability.</p>
      <p><strong>Red:</strong> Can evoke excitement, passion, or warning.</p>
      <p><strong>Green:</strong> Frequently connected to growth, health, and nature.</p>
      <p><strong>Yellow:</strong> Often perceived as optimistic, energetic, and attention-grabbing.</p>
      <p>Understanding these associations can help you select colors that reinforce your message and brand personality.</p>

      <h2 id="accessibility">Color and Accessibility</h2>
      <p>When using color in digital design, accessibility must be a primary consideration. Ensure sufficient contrast between text and background colors (WCAG recommends a minimum contrast ratio of 4.5:1 for normal text).</p>
      <p>Additionally, never rely on color alone to convey information, as this excludes users with color vision deficiencies. Always provide additional visual cues or text labels.</p>

      <h2 id="conclusion">Conclusion</h2>
      <p>Mastering color theory allows designers to create more impactful, accessible, and effective digital products. By understanding the basics of color, creating harmonious palettes, considering emotional impact, and ensuring accessibility, you can harness the full power of color in your designs.</p>
      <p>Remember that color choices should always support your design goals and enhance the user experience, rather than distract from it. When used thoughtfully, color becomes an essential element in communicating your message and guiding users through your digital product.</p>
    `,
    coverImage: "https://images.unsplash.com/photo-1550859492-d5da9d8e45f3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    date: "2023-12-19",
  ...
  },
  {
    ...
    excerpt: "Learn how to craft compelling visual narratives that engage audiences and communicate complex ideas effectively.",
    content: `
      <p>Visual storytelling combines imagery, design, and narrative to communicate messages, evoke emotions, and engage audiences. In this article, we'll explore the principles of effective visual storytelling and how you can apply them in your design work.</p>

      <h2 id="narrative-elements">Core Elements of Visual Narrative</h2>
      <p>Effective visual storytelling relies on several key elements:</p>
      <p><strong>Characters:</strong> The subjects or focal points that audiences can connect with emotionally.</p>
      <p><strong>Setting:</strong> The environment or context that frames your story.</p>
      <p><strong>Plot:</strong> The sequence of events or progression that creates narrative momentum.</p>
      <p><strong>Conflict:</strong> The tension or problem that drives interest and engagement.</p>
      <p><strong>Resolution:</strong> The satisfying conclusion or call-to-action.</p>

      <h2 id="visual-hierarchy">Creating Visual Hierarchy</h2>
      <p>Visual hierarchy guides viewers through your story in the intended order. Use size, contrast, color, and positioning to direct attention and establish the relative importance of different elements.</p>
      <p>Remember that Western readers typically scan in an F or Z pattern, while design elements can intentionally disrupt these patterns to create visual interest.</p>

      <h2 id="emotional-design">Designing for Emotional Impact</h2>
      <p>Emotion is at the heart of compelling storytelling. Color, typography, imagery, and composition all contribute to the emotional tone of your visual narrative.</p>
      <p>Consider how different design choices evoke different feelings. For example, high-contrast, angular compositions might create tension, while soft, curved forms tend to feel more comforting.</p>

      <h2 id="consistency">Maintaining Consistency</h2>
      <p>Consistency in visual elements helps create a cohesive narrative. Develop a visual style that supports your story and apply it consistently across all touchpoints.</p>
      <p>This doesn't mean every element must be identical—variation creates interest—but there should be a recognizable visual language that ties everything together.</p>

      <h2 id="conclusion">Conclusion</h2>
      <p>Visual storytelling is a powerful tool for communication in an increasingly visual culture. By understanding narrative principles and applying them through thoughtful design, you can create more engaging, memorable, and effective experiences for your audience.</p>
      <p>Remember that the best visual stories don't just look beautiful—they communicate meaning, evoke emotion, and inspire action. With practice and intention, you can master the art of visual storytelling and elevate your design work to new heights.</p>
    `,
    coverImage: "https://images.unsplash.com/photo-1561214115-f2f134cc4912?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    date: "2024-01-07",
...
// Function to get featured posts (just using the newest ones for this example)
