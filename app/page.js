      ...
      <section className="bg-gradient-to-r from-indigo-500 to-purple-600 dark:from-indigo-700 dark:to-purple-800 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Discover blogs on design principles, user experience, and creative
            techniques to elevate your digital products.
          </p>
      ...
      {/* <section className="container mx-auto px-4 py-16">
        <div className="bg-indigo-600 dark:bg-indigo-800 rounded-xl p-8 md:p-12 text-center">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
            Our collection of articles covers everything from minimalist design
            principles to color theory and typography fundamentals.
          </p>
          <Link
            href="/blogs"
            className="btn bg-white text-indigo-600 hover:bg-gray-100"
